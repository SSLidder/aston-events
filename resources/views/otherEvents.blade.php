...
{{-- <div class = "display_events">
    ...
    <div class = event_view><a href = "{{ route('otherEvent1') }}">Click here to view more details!</a></div>
</div> --}}
...
<div class = "table">
    <table>
        ...
        <tr>
            ...
            <td class = "details"> <a href = "{{ route('otherEvent1') }}">Click here to view details on the event!</a></td>
        </tr>
    </table>
</div>
